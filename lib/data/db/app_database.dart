...
class AppDatabase extends _$AppDatabase {
  ...
  MigrationStrategy get migration => MigrationStrategy(
    ...
    onUpgrade: (m, from, to) async {
      // v1: nothing. Future: stepwise `if (from < N)` additive blocks.
      // Before any real onUpgrade, bootstrap makes a plain file copy of
      // the (already device-key-encrypted) db to
      // db/pre-migration-v<from>.db; deleted on success. No passphrase
      // involved.
    },
